...
//get user method
//verifyTokenAndAdmin bcoz only admin gets user 
...
router.get("/",verifyTokenAndAdmin,async(req,res)=>{
    ...
    try{
            ...
            .sort({_id:-1})/*curly braces means object*/
            .limit(1)
            : await User.find();
...
//GET USER STATS=total no of users per month for e.g. sept-10 users,augt-5
